...
export default function RoastPage() {
  ...
  const shareText = result
    ? `I just got my resume roasted by AI and scored ${result.overall_score}/100. Think you can do better?`
    : ''
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Paste a job description and your resume. Our AI will score it, find keyword gaps, and
            deliver a brutally honest roast — with actionable fixes.
          </p>
        </motion.div>
        ...
        <div className="text-center mb-12">
          ...
          {resume.length > 0 && resume.length < 50 && (
            <p className="text-orange-400 text-xs mt-2">
              Resume needs at least 50 characters
            </p>
          )}
        </div>
        ...
        <AnimatePresence>
          {loading && (
            ...
            >
              ...
              <p className="text-gray-400 mt-4 text-sm">{LOADING_MESSAGES[loadingMsgIdx]}</p>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          >
              ...
              >
                <div className="pt-3 space-y-3">
                  {result.impact_score.strong_bullets.length > 0 && (
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Strong Bullets</p>
                  ...
                  {result.impact_score.weak_bullets.length > 0 && (
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Weak Bullets</p>
                      <ul className="space-y-1.5">
              ...
              >
                <div className="pt-3">
                  {result.ats_compatibility.issues.length > 0 ? (
                    ...
                    <p className="text-sm text-emerald-400">No ATS issues detected.</p>
                  )}
                </div>
              </CategoryAccordion>
              ...
              >
                <div className="pt-3 space-y-3">
                  {result.skills_gap.covered.length > 0 && (
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Covered</p>
                      <div className="flex flex-wrap gap-1.5">
            ...
            <div className="max-w-2xl mx-auto text-center p-8 rounded-2xl bg-gradient-to-r from-brand/10 to-accent/10 border border-brand/20">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Resume Studio generates ATS-optimized resumes, cover letters, and more — tailored to every job.
              </p>
              <div className="flex flex-wrap justify-center gap-3">
                <Link
                  href="/signup"
